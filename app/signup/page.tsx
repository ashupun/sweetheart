...
export default function Signup() {
  ...
  const validate = () => {
    ...
    else if (username.length < 3) newErrors.username = "username must be 3+ characters ♡";
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            <div className="relative">
              <div className={`flex items-center border-b ${errors.username ? "border-pink-500" : "border-gray-300 dark:border-gray-700"}`}>
                <span className="py-3 text-sm text-gray-400 dark:text-gray-600">
                  sweethe.art/
                </span>
                <input
                  type="text"
